...
; Characteristics of each move.
	...
	move VICEGRIP,     NO_ADDITIONAL_EFFECT,        55, WATER,        100, 30
	move GUILLOTINE,   OHKO_EFFECT,                  1, NORMAL,        30,  5
	move RAZOR_WIND,   HYPER_BEAM_EFFECT,           80, FLYING,       100, 10
	move SWORDS_DANCE, ATTACK_UP2_EFFECT,            0, TYPELESS,     100, 30
	...
	move WHIRLWIND,    SWITCH_AND_TELEPORT_EFFECT,   0, TYPELESS,      85, 20
	...
	move TAIL_WHIP,    DEFENSE_DOWN1_EFFECT,         0, TYPELESS,     100, 30
	...
	move LEER,         DEFENSE_DOWN1_EFFECT,         0, TYPELESS,     100, 30
	move BITE,         FLINCH_SIDE_EFFECT1,         60, DARK,         100, 25
	move GROWL,        ATTACK_DOWN1_EFFECT,          0, TYPELESS,     100, 40
	move ROAR,         SWITCH_AND_TELEPORT_EFFECT,   0, TYPELESS,     100, 20
	move SING,         SLEEP_EFFECT,                 0, TYPELESS,      55, 15
	move SUPERSONIC,   CONFUSION_EFFECT,             0, TYPELESS,      70, 20
	move SONICBOOM,    SPECIAL_DAMAGE_EFFECT,        1, NORMAL,       100, 20
	move DISABLE,      DISABLE_EFFECT,               0, TYPELESS,      75, 20
	...
	move GROWTH,       SPECIAL_UP1_EFFECT,           0, TYPELESS,     100, 40
	...
	move MEDITATE,     ATTACK_UP1_EFFECT,            0, TYPELESS,     100, 40
	move AGILITY,      SPEED_UP2_EFFECT,             0, TYPELESS,     100, 30
	...
	move MIMIC,        MIMIC_EFFECT,                 0, TYPELESS,     100, 10
	move SCREECH,      DEFENSE_DOWN2_EFFECT,         0, TYPELESS,      85, 40
	move DOUBLE_TEAM,  EVASION_UP1_EFFECT,           0, TYPELESS,     100, 15
	move RECOVER,      HEAL_EFFECT,                  0, TYPELESS,     100, 20
	move HARDEN,       DEFENSE_UP1_EFFECT,           0, TYPELESS,     100, 30
	move MINIMIZE,     EVASION_UP1_EFFECT,           0, TYPELESS,     100, 20
	move SMOKESCREEN,  ACCURACY_DOWN1_EFFECT,        0, TYPELESS,     100, 20
	move CONFUSE_RAY,  CONFUSION_EFFECT,             0, GHOST,        100, 10
	move WITHDRAW,     DEFENSE_UP1_EFFECT,           0, TYPELESS,     100, 40
	move DEFENSE_CURL, DEFENSE_UP1_EFFECT,           0, TYPELESS,     100, 40
	move BARRIER,      DEFENSE_UP2_EFFECT,           0, TYPELESS,	  100, 30
	move LIGHT_SCREEN, LIGHT_SCREEN_EFFECT,          0, TYPELESS,     100, 30
	move HAZE,         HAZE_EFFECT,                  0, TYPELESS,     100, 30
	...
	move AMNESIA,      SPECIAL_UP2_EFFECT,           0, TYPELESS,     100, 20
	move KINESIS,      ACCURACY_DOWN1_EFFECT,        0, TYPELESS,      80, 15
	move SOFTBOILED,   HEAL_EFFECT,                  0, TYPELESS,     100,  5
	move HI_JUMP_KICK, JUMP_KICK_EFFECT,           120, FIGHTING,      90, 20
	move GLARE,        PARALYZE_EFFECT,              0, TYPELESS,      90, 30
	...
	move LOVELY_KISS,  SLEEP_EFFECT,                 0, TYPELESS,      75, 10
	move SKY_ATTACK,   NO_ADDITIONAL_EFFECT,        120, FLYING,       85, 10
	move TRANSFORM,    TRANSFORM_EFFECT,             0, TYPELESS,     100, 10
	move BUBBLE,       SPEED_DOWN_SIDE_EFFECT,      10, WATER,        100, 30
	move DIZZY_PUNCH,  CONFUSION_SIDE_EFFECT,       70, NORMAL,       100, 20
	move SPORE,        SLEEP_EFFECT,                 0, GRASS,        100, 15
	move FLASH,        ACCURACY_DOWN1_EFFECT,        0, TYPELESS,      70, 20
	move PSYWAVE,      SPECIAL_DAMAGE_EFFECT,        1, PSYCHIC_TYPE,  95, 15
	move SPLASH,       SPLASH_EFFECT,                0, TYPELESS,     100, 40
	move ACID_ARMOR,   DEFENSE_UP2_EFFECT,           0, TYPELESS,     100, 40
	...
	move DRACO_METER,  NO_ADDITIONAL_EFFECT,		80, DRAGON,		   90, 10
